...
#
# Generated by export_simulation on Sun Feb 13 18:26:59 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './dynamic_digital_0.sh' script.

./dynamic_digital_0.sh -reset_run
...
./dynamic_digital_0.sh -noclean_files

For more information on the script, please type './dynamic_digital_0.sh -help'.
