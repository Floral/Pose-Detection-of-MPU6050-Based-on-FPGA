...
#
# Generated by export_simulation on Tue Mar 15 10:56:41 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_sync_0.sh' script.

./fifo_sync_0.sh -reset_run
...
./fifo_sync_0.sh -noclean_files

For more information on the script, please type './fifo_sync_0.sh -help'.
