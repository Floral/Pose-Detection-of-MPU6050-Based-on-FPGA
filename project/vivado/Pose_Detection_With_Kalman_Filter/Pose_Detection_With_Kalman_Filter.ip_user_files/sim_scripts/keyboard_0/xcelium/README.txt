...
#
# Generated by export_simulation on Sun Feb 13 18:27:19 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './keyboard_0.sh' script.

./keyboard_0.sh -reset_run
...
./keyboard_0.sh -noclean_files

For more information on the script, please type './keyboard_0.sh -help'.
